...
@section('content')
    <div class="admin-form-page">
        <section class="admin-form-hero admin-surface">
            <p class="admin-form-kicker">Akun</p>
            <h1 class="admin-form-title">Buat akun baru</h1>
        </section>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data" class="admin-card-white admin-form-card">
            ...
            <div class="admin-form-grid two">
                <div>
                    <label>Password <small id="passwordHint" style="color:#94a3b8;font-weight:600;">(wajib untuk admin/dosen)</small></label>
    ...
    <script>
        function toggleStudentFields() {
            ...
            document.getElementById('password').required = !isStudent;
            document.getElementById('password_confirmation').required = !isStudent;
            document.getElementById('passwordHint').textContent = isStudent ? '(boleh kosong, default memakai NIM)' : '(wajib untuk admin/dosen)';
        }
        toggleStudentFields();
    </script>
@endsection
